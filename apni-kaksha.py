...
async def start(bot, update):
       await update.reply_text("Hi i am **Apni Kaksha Downloader**.\n\n"
                              "**NOW:-** "
                                       
                                       "Press **/login** to continue..\n\n"
                                     "Bot made by **Ayush**" )

url="https://spec.kotakakshaadmin.com/api/v1/"
...
async def account_login(bot: Client, m: Message):
    ...
    url1 = requests.get("https://spec.kotakakshaadmin.com/api/v1/my-batch?&token="+token)
...
# topic id url = https://elearn.crwilladmin.com/api/v3/comp/batch-topic/881?type=class&token=d76fce74c161a264cf66b972fd0bc820992fe576
    url2 = requests.get("https://spec.kotakakshaadmin.com/api/v1/batch-topic/"+raw_text2+"?type=class&token="+token)
...
#     await m.reply_text(f'Batch details of **{bn}** are :')
    ...
    for data in topicid:
        ...
        urlx = "https://spec.kotakakshaadmin.com/api/v1/batch-detail/"+raw_text2+"?redirectBy=mybatch&topicId="+tid+"&token="+token
...
#                  p =xvv[z]
            ...
            url3 = "https://spec.kotakakshaadmin.com/api/v1/comp/batch-detail/"+raw_text2+"?redirectBy=mybatch&topicId="+t+"&token="+token   
...
#                     lessonName = re.sub('\|', '_', cf)
                    ...
                    if bcvid.startswith("62"):
                        try:
                            ...
                            surl=requests.get("https://spec.kotakakshaadmin.com/api/v1/livestreamToken?type=brightcove&vid="+vidid+"&token="+token)
